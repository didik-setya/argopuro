    ...
    <div class="card-body">
        ...
        <table class="table table-responsive table-bordered text-nowrap" id="table-evaluasi">
            ...
            <tbody id="content">
                ...
                <?php foreach ($ip_luar_ijin as $key) :

                    $dataperumahan = $this->laporan->get_data_tanah_menu2($key->proyek_id);
                    $perumahan = $this->laporan->get_tanah_menu2($key->proyek_id, date('Y' . '-01-01'), date('Y') . '-12-31', $key->status_proyek);
                ?>
                    <tr class="table-secondary">
                        <td class="text-bold">Proyek - <?= $dataperumahan['nama_proyek'] ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <?php
                    $i = 1;
                    foreach ($perumahan as $value => $data) : ?>
                        <?php
                    ...
                    <?php endforeach ?>
                <?php endforeach ?>
                <!-- IP LOKASI LUAR IJIN END -->

                <!-- IP LOKASI DALAM IJIN START -->
                <tr class="table-warning">
                    <td class="text-bold text-nowrap">
                        IP Proyek - Dalam Ijin
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <?php foreach ($ip_dalam_ijin as $key) :
                ...
                ?>
                    ...
                    <?php endforeach ?>
                <?php endforeach ?>
                <!-- IP LOKASI DALAM IJIN END -->

                <!-- IP LOKASI LOKASI START -->
                <tr class="table-warning">
                    <td class="text-bold">
                        IP Proyek - Lokasi
                    </td>
