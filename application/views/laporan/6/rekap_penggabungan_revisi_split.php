<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12">
                <h3>Rekap Penggabungan Induk</h3>

                <div class="card">
                    <div class="card-body table-responsive">

                        <form action="<?php echo site_url('export/rekap_revisi_split/') ?>" method="get">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <table class="table table-bordered table-sm mt-2" id="table-rekap-penggabungan">
                            <thead>
                            ...
                            <tbody>
                                ...
                                foreach ($rekap_penggabungan as $r) {
                                    ...
                                    $pro_old_bid = $this->laporan->count_bidluas_rekap($r->proyek_id, 'dil', 'proses', null, $last_year)->num_rows();
                                    $get_pro_old_luas = $this->laporan->count_bidluas_rekap($r->proyek_id, 'luas', 'proses', null, $last_year)->row()->luas_terbit;
                                    if ($get_pro_old_luas) {
                                    ...
                                    $pro_new_bid = $this->laporan->count_bidluas_rekap($r->proyek_id, 'dil', 'proses', $this_year)->num_rows();
                                    $get_pro_new_luas = $this->laporan->count_bidluas_rekap($r->proyek_id, 'luas', 'proses', $this_year)->row()->luas_terbit;
                                    if ($get_pro_new_luas) {
                                    ...
                                    $terb_bid = $this->laporan->count_bidluas_rekap($r->proyek_id, 'dil', 'terbit', $this_year)->num_rows();
                                    $get_terb_luas = $this->laporan->count_bidluas_rekap($r->proyek_id, 'luas', 'terbit', $this_year)->row()->luas_terbit;
                                    if ($get_terb_luas) {
...
<script>
    ...
    $(document).ready(function() {
        $('#table-rekap-penggabungan').dataTable({
            "scrollX": true,
            "searching": true,
            "ordering": false,
            "autoWidth": false,
    ...
    function reload_filter() {
        ...
        let url = '<?= base_url('dashboard/rekap_revisi_split') ?>?proyek=' + proyek + '&status=' + status;
