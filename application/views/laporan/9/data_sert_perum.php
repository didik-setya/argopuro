                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table class="table table-bordered" id="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="bg-warning">
                                        <th colspan="15"><?= $stat['title'] ?></th>
                                    </tr>

                                    <!-- data last year -->
                                    <tr style="background-color: #c7c7c7;">
                                        <td colspan="15">s/d Tahun <?= $last_year ?></td>
                                    </tr>
                                    <?php if (!empty($data_lastyear)) { ?>
                                        <?php $i = 1;
                                        foreach ($data_lastyear as $dt) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#" onclick="edit_data('<?= $dt->id_splitsing ?>')">
                                                                <i class="far fa-edit"></i> Edit
                                                            </a>
                                                            <a class="dropdown-item" href="#" onclick="delete_data('<?= $dt->id_splitsing ?>')">
                                                ...
                                                <td><?= cek_tgl($dt->tgl_penjualan) ?></td>
                                                <td><?= $dt->pembeli ?></td>
                                                <td><?= $dt->type ?></td>
                                                <td><?= $dt->blok ?></td>
                                                <td>1</td>
                                                ...
                                                <td><?= $dt->luas_kavling - $dt->luas_terbit ?></td>
                                                <td>
                                                    <?php
                                                    if ($dt->status_penjualan == 'belum proses') {
                                                        echo '-';
                                                    } else {
                                                        echo cek_tgl($dt->tgl_proses);
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                ...
                                                <td><?= $dt->no_shgb ?></td>
                                                <td><?= cek_tgl($dt->masa_berlaku) ?></td>
                                                <td><?= $dt->keterangan ?></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <tr>
                                            <td colspan="15" class="text-danger text-center">No data result</td>
                                        </tr>
                                    <?php } ?>
                                    <!-- end data last year -->
                                    ...
                                    <!-- data this year -->
                                    <tr style="background-color: #c7c7c7;">
                                        <td colspan="15">Tahun <?= $this_year ?></td>
                                    </tr>
                                    <?php if (!empty($data_thisyear)) { ?>
                                        <?php $i = 1;
